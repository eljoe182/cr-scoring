...
export default class ManagementHistoryRepository
  implements IManagementHistoryRepository<GetManagementHistoryRepositoryParams, IManagementHistoryDataRepository>
{
  constructor(private orm: DataSource) {}

  async getManagementHistory(
    params: GetManagementHistoryRepositoryParams
  ): Promise<IManagementHistoryDataRepository[]> {
